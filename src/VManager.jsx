...
const seedProducts = [
  ...
  { id: 1,  name: "Vestige Neem 100 tabs",              category: "Ayurvedic",    buyPrice: 360,  mrp: 515,  stock: 0, unit: "Pack" },
  { id: 2,  name: "Vestige Flex Oil (Omega-3) 90 tabs", category: "Ayurvedic",    buyPrice: 570,  mrp: 810,  stock: 0, unit: "Pack" },
  { id: 3,  name: "Vestige Spirulina 100 tabs",         category: "Ayurvedic",    buyPrice: 380,  mrp: 540,  stock: 0, unit: "Pack" },
  { id: 4,  name: "Vestige Noni 90 tabs",               category: "Ayurvedic",    buyPrice: 530,  mrp: 755,  stock: 0, unit: "Pack" },
  { id: 5,  name: "Vestige Aloe Vera 60 tabs",          category: "Ayurvedic",    buyPrice: 290,  mrp: 415,  stock: 0, unit: "Pack" },
  { id: 6,  name: "Vestige Amla (Vitamin-C) 60 tabs",   category: "Ayurvedic",    buyPrice: 185,  mrp: 265,  stock: 0, unit: "Pack" },
  { id: 7,  name: "Vestige Ganoderma 90 tabs",          category: "Ayurvedic",    buyPrice: 825,  mrp: 1180, stock: 0, unit: "Pack" },
  { id: 8,  name: "Vestige Colostrum 60 tabs",          category: "Ayurvedic",    buyPrice: 615,  mrp: 875,  stock: 0, unit: "Pack" },
  { id: 9,  name: "Vestige Glucosamine 60 tabs",        category: "Ayurvedic",    buyPrice: 520,  mrp: 740,  stock: 0, unit: "Pack" },
  { id: 10, name: "Vestige Glucosamine 100 tabs",       category: "Ayurvedic",    buyPrice: 810,  mrp: 1150, stock: 0, unit: "Pack" },
  { id: 11, name: "Vestige Collagen 10 Sachets",        category: "Ayurvedic",    buyPrice: 600,  mrp: 700,  stock: 0, unit: "Pack" },
  { id: 12, name: "Vestige L Arginine 15x10g",          category: "Ayurvedic",    buyPrice: 1390, mrp: 1990, stock: 0, unit: "Pack" },
  { id: 13, name: "Vestige Protein Powder 200g",        category: "Ayurvedic",    buyPrice: 995,  mrp: 1190, stock: 0, unit: "Jar"  },
  { id: 14, name: "Vestige Protein Powder 400g",        category: "Ayurvedic",    buyPrice: 1870, mrp: 2655, stock: 0, unit: "Pack" },
  { id: 15, name: "Vestige Fiber 200g",                 category: "Ayurvedic",    buyPrice: 950,  mrp: 1350, stock: 0, unit: "Pack" },
  { id: 16, name: "Vestige Folic & Iron Plus 60 tabs",  category: "Ayurvedic",    buyPrice: 240,  mrp: 345,  stock: 0, unit: "Pack" },
  { id: 17, name: "Vestige Calcium 100 tabs",           category: "Ayurvedic",    buyPrice: 250,  mrp: 355,  stock: 0, unit: "Pack" },
  { id: 18, name: "Vestige Stevia 100 tabs",            category: "Ayurvedic",    buyPrice: 140,  mrp: 200,  stock: 0, unit: "Pack" },
  { id: 19, name: "Vestige Cranberry 60 tabs",          category: "Ayurvedic",    buyPrice: 1630, mrp: 2315, stock: 0, unit: "Pack" },
  { id: 20, name: "Vestige U-Control 30 tabs",          category: "Ayurvedic",    buyPrice: 1400, mrp: 1600, stock: 0, unit: "Pack" },
  { id: 21, name: "Vestige Pre Glucohealth 60 tabs",    category: "Ayurvedic",    buyPrice: 870,  mrp: 1020, stock: 0, unit: "Pack" },
  { id: 22, name: "Vestige Eye Support 30 tabs",        category: "Ayurvedic",    buyPrice: 575,  mrp: 820,  stock: 0, unit: "Pack" },
  { id: 23, name: "Vestige Hair Skin & Nail 90 tabs",   category: "Ayurvedic",    buyPrice: 540,  mrp: 630,  stock: 0, unit: "Pack" },
  { id: 24, name: "Vestige Curcumin Plus 60 tabs",      category: "Ayurvedic",    buyPrice: 900,  mrp: 1280, stock: 0, unit: "Pack" },
  { id: 25, name: "Vestige Shatavari Max 90 tabs",      category: "Ayurvedic",    buyPrice: 460,  mrp: 655,  stock: 0, unit: "Pack" },
  { id: 26, name: "Vestige Detox Foot Patches 10 pcs",  category: "Ayurvedic",    buyPrice: 1270, mrp: 1810, stock: 0, unit: "Pack" },
  { id: 27, name: "Vestige Coenzyme Q10 30 tabs",       category: "Ayurvedic",    buyPrice: 995,  mrp: 1415, stock: 0, unit: "Pack" },
  { id: 28, name: "Veslim Protein 200g",                category: "Ayurvedic",    buyPrice: 1000, mrp: 1430, stock: 0, unit: "Pack" },
  { id: 29, name: "Veslim Protein 400g",                category: "Ayurvedic",    buyPrice: 2000, mrp: 2860, stock: 0, unit: "Pack" },
  { id: 30, name: "Veslim Shake Weight Loss 500g",      category: "Ayurvedic",    buyPrice: 1850, mrp: 2630, stock: 0, unit: "Pack" },
  { id: 31, name: "Veslim Capsules 90 tabs",            category: "Ayurvedic",    buyPrice: 1100, mrp: 1565, stock: 0, unit: "Pack" },
  { id: 32, name: "Veslim Energy Drink Mix 40g",        category: "Ayurvedic",    buyPrice: 675,  mrp: 960,  stock: 0, unit: "Pack" },
  { id: 33, name: "Veslim Tea 150g",                    category: "Ayurvedic",    buyPrice: 745,  mrp: 1060, stock: 0, unit: "Pack" },
  { id: 34, name: "Veslim Shake Mix 500g",              category: "Ayurvedic",    buyPrice: 530,  mrp: 699,  stock: 0, unit: "Pack" },
  { id: 35, name: "Veslim Shaker",                      category: "Ayurvedic",    buyPrice: 299,  mrp: 350,  stock: 0, unit: "Piece"},
  { id: 36, name: "Ayusante Procard 60 tabs",           category: "Ayurvedic",    buyPrice: 820,  mrp: 1165, stock: 0, unit: "Pack" },
  { id: 37, name: "Ayusante Glucohealth 60 tabs",       category: "Ayurvedic",    buyPrice: 680,  mrp: 965,  stock: 0, unit: "Pack" },
  { id: 38, name: "Ayusante Toxclean 60 tabs",          category: "Ayurvedic",    buyPrice: 705,  mrp: 1000, stock: 0, unit: "Pack" },
  { id: 39, name: "Ayusante Vital Complex 60 tabs",     category: "Ayurvedic",    buyPrice: 765,  mrp: 1090, stock: 0, unit: "Pack" },
  { id: 40, name: "Ayusante Kidney Health 60 tabs",     category: "Ayurvedic",    buyPrice: 650,  mrp: 925,  stock: 0, unit: "Pack" },
  { id: 41, name: "Ayusante Liver Health 60 tabs",      category: "Ayurvedic",    buyPrice: 655,  mrp: 930,  stock: 0, unit: "Pack" },
  { id: 42, name: "Ayusante Respocare 60 tabs",         category: "Ayurvedic",    buyPrice: 625,  mrp: 890,  stock: 0, unit: "Pack" },
  { id: 43, name: "Ayusante Prostate Care 60 tabs",     category: "Ayurvedic",    buyPrice: 450,  mrp: 640,  stock: 0, unit: "Pack" },
  // ── VESTIGE PRIME ──────────────────────────────────────────────────────────
  { id: 44, name: "Krill Oil 30 tabs",                  category: "Vestige Prime",buyPrice: 1315, mrp: 1880, stock: 0, unit: "Pack" },
  { id: 45, name: "Combiotics 30 tabs",                 category: "Vestige Prime",buyPrice: 570,  mrp: 810,  stock: 0, unit: "Pack" },
  { id: 46, name: "Sea Buckthorn 60 tabs",              category: "Vestige Prime",buyPrice: 850,  mrp: 1220, stock: 0, unit: "Pack" },
  { id: 47, name: "Multivitamin Gummies 60 tabs",       category: "Vestige Prime",buyPrice: 750,  mrp: 1065, stock: 0, unit: "Pack" },
  { id: 48, name: "Absorvit Spray Multivitamin/B12",    category: "Vestige Prime",buyPrice: 540,  mrp: 625,  stock: 0, unit: "Piece"},
  { id: 49, name: "Absorvit Spray Vit C / Vit D",       category: "Vestige Prime",buyPrice: 480,  mrp: 685,  stock: 0, unit: "Piece"},
  { id: 50, name: "Absorvit Spray Melatonin",           category: "Vestige Prime",buyPrice: 550,  mrp: 645,  stock: 0, unit: "Piece"},
  { id: 51, name: "Absorvit Spray Biotin",              category: "Vestige Prime",buyPrice: 690,  mrp: 980,  stock: 0, unit: "Piece"},
  { id: 52, name: "Energy Booster 30 tabs",             category: "Vestige Prime",buyPrice: 895,  mrp: 1050, stock: 0, unit: "Pack" },
  { id: 53, name: "Concentrated Mineral Drops 60ml",   category: "Vestige Prime",buyPrice: 970,  mrp: 1210, stock: 0, unit: "Bottle"},
  // ── HEALTH CARE & HEALTH FOOD ───────────────────────────────────────────────
  { id: 54, name: "Invigo Nutri Drink Choco 200g",      category: "Health Food",  buyPrice: 645,  mrp: 920,  stock: 0, unit: "Pack" },
  { id: 55, name: "Invigo Nutri Drink Choco 500g",      category: "Health Food",  buyPrice: 1295, mrp: 1840, stock: 0, unit: "Pack" },
  { id: 56, name: "Invigo Nutri Drink Vanilla 200g",    category: "Health Food",  buyPrice: 625,  mrp: 890,  stock: 0, unit: "Pack" },
  { id: 57, name: "Invigo Fresh-n-Up Drink Orange 200g",category: "Health Food",  buyPrice: 200,  mrp: 285,  stock: 0, unit: "Pack" },
  { id: 58, name: "Enerva Choco Flaxseed Bar 30g",      category: "Health Food",  buyPrice: 50,   mrp: 75,   stock: 0, unit: "Piece"},
  { id: 59, name: "Enerva Break Fast Cereal 350g",      category: "Health Food",  buyPrice: 299,  mrp: 430,  stock: 0, unit: "Pack" },
  { id: 60, name: "Zeta Premium Spice Tea 200g",        category: "Health Food",  buyPrice: 295,  mrp: 420,  stock: 0, unit: "Pack" },
  { id: 61, name: "Zeta Special Tea 200g",              category: "Health Food",  buyPrice: 135,  mrp: 192,  stock: 0, unit: "Pack" },
  { id: 62, name: "Zeta Premium Coffee 50g",            category: "Health Food",  buyPrice: 220,  mrp: 315,  stock: 0, unit: "Pack" },
  { id: 63, name: "Lite House Rice Bran Oil 2 Ltr",     category: "Health Food",  buyPrice: 540,  mrp: 780,  stock: 0, unit: "Bottle"},
  { id: 64, name: "Invigo Tulsi Health Drops 30ml",     category: "Health Food",  buyPrice: 175,  mrp: 250,  stock: 0, unit: "Bottle"},
  // ── ASSURE NATURAL ─────────────────────────────────────────────────────────
  { id: 65, name: "Assure Face Scrub 75g",              category: "Assure Natural",buyPrice: 265, mrp: 380,  stock: 0, unit: "Pack" },
  { id: 66, name: "Assure Charcoal Peel-Off Mask 75g",  category: "Assure Natural",buyPrice: 245, mrp: 350,  stock: 0, unit: "Pack" },
  { id: 67, name: "Assure Sunscreen SPF-40+ 75g",       category: "Assure Natural",buyPrice: 435, mrp: 620,  stock: 0, unit: "Pack" },
  { id: 68, name: "Assure Day Cream 100g",              category: "Assure Natural",buyPrice: 310, mrp: 440,  stock: 0, unit: "Pack" },
  { id: 69, name: "Assure Lightening SPF 15 75g",       category: "Assure Natural",buyPrice: 360, mrp: 515,  stock: 0, unit: "Pack" },
  { id: 70, name: "Assure Hand & Body Cream 100g",      category: "Assure Natural",buyPrice: 325, mrp: 380,  stock: 0, unit: "Pack" },
  { id: 71, name: "Assure Hair Mask 150g",              category: "Assure Natural",buyPrice: 365, mrp: 520,  stock: 0, unit: "Pack" },
  // ── PERSONAL CARE ──────────────────────────────────────────────────────────
  { id: 72, name: "Assure Neem Soap 100g",              category: "Personal Care", buyPrice: 50,   mrp: 75,   stock: 0, unit: "Bar"  },
  { id: 73, name: "Assure Complexion Bar Soap 75g",     category: "Personal Care", buyPrice: 70,   mrp: 100,  stock: 0, unit: "Bar"  },
  { id: 74, name: "Assure Creamy Bar Soap 75g",         category: "Personal Care", buyPrice: 58,   mrp: 85,   stock: 0, unit: "Bar"  },
  { id: 75, name: "Assure Germ Protection Soap 75g",    category: "Personal Care", buyPrice: 53,   mrp: 80,   stock: 0, unit: "Bar"  },
  { id: 76, name: "Dentassure Toothbrush 4 pcs",        category: "Personal Care", buyPrice: 220,  mrp: 315,  stock: 0, unit: "Pack" },
  { id: 77, name: "Dentassure Toothpaste 100g",         category: "Personal Care", buyPrice: 72,   mrp: 105,  stock: 0, unit: "Pack" },
  { id: 78, name: "Dentassure Whitening Toothpaste 90g",category: "Personal Care", buyPrice: 125,  mrp: 180,  stock: 0, unit: "Pack" },
  { id: 79, name: "Dentassure Gano Toothpaste 100g",    category: "Personal Care", buyPrice: 150,  mrp: 215,  stock: 0, unit: "Pack" },
  { id: 80, name: "Assure Active Deo 150ml",            category: "Personal Care", buyPrice: 185,  mrp: 265,  stock: 0, unit: "Bottle"},
  { id: 81, name: "Assure Rapture Deo 150ml",           category: "Personal Care", buyPrice: 175,  mrp: 205,  stock: 0, unit: "Bottle"},
  { id: 82, name: "Assure Perfume Spray 125ml",         category: "Personal Care", buyPrice: 275,  mrp: 325,  stock: 0, unit: "Bottle"},
  { id: 83, name: "Assure Pocket Perfume Spray",        category: "Personal Care", buyPrice: 85,   mrp: 100,  stock: 0, unit: "Piece"},
  { id: 84, name: "Dentassure Mouth Wash 250ml",        category: "Personal Care", buyPrice: 175,  mrp: 205,  stock: 0, unit: "Bottle"},
  { id: 85, name: "Assure Talc 100g",                   category: "Personal Care", buyPrice: 58,   mrp: 85,   stock: 0, unit: "Pack" },
  { id: 86, name: "Assure Hair Oil 200ml",              category: "Personal Care", buyPrice: 180,  mrp: 260,  stock: 0, unit: "Bottle"},
  { id: 87, name: "Assure Hand Wash 250ml",             category: "Personal Care", buyPrice: 130,  mrp: 185,  stock: 0, unit: "Bottle"},
  { id: 88, name: "Assure Hand & Body Lotion 200ml",    category: "Personal Care", buyPrice: 191,  mrp: 275,  stock: 0, unit: "Bottle"},
  { id: 89, name: "Assure Foot Cream 50g",              category: "Personal Care", buyPrice: 141,  mrp: 200,  stock: 0, unit: "Pack" },
  { id: 90, name: "Assure BB Cream SPF 30+ 30g",        category: "Personal Care", buyPrice: 340,  mrp: 485,  stock: 0, unit: "Pack" },
  { id: 91, name: "Assure Sun Defense SPF 30+ 60g",     category: "Personal Care", buyPrice: 225,  mrp: 320,  stock: 0, unit: "Pack" },
  { id: 92, name: "Assure Anti-Ageing Night Cream 60g", category: "Personal Care", buyPrice: 219,  mrp: 315,  stock: 0, unit: "Pack" },
  { id: 93, name: "Assure Fairness Cream 50g",          category: "Personal Care", buyPrice: 169,  mrp: 240,  stock: 0, unit: "Pack" },
  { id: 94, name: "Assure Aloe Cucumber Aquagel 100ml", category: "Personal Care", buyPrice: 270,  mrp: 385,  stock: 0, unit: "Bottle"},
  { id: 95, name: "Assure Instant Glow Face Pack 60g",  category: "Personal Care", buyPrice: 146,  mrp: 170,  stock: 0, unit: "Pack" },
  { id: 96, name: "Assure Clarifying Face Wash 60g",    category: "Personal Care", buyPrice: 146,  mrp: 210,  stock: 0, unit: "Pack" },
  { id: 97, name: "Assure Facial Kit 5 kits",           category: "Personal Care", buyPrice: 620,  mrp: 880,  stock: 0, unit: "Pack" },
  { id: 98, name: "Assure Purifying Cleanser+Toner 200ml",category: "Personal Care",buyPrice: 270, mrp: 385,  stock: 0, unit: "Bottle"},
  { id: 99, name: "Assure Daily Moisturizer 200ml",     category: "Personal Care", buyPrice: 248,  mrp: 355,  stock: 0, unit: "Bottle"},
  { id: 100,name: "Assure Insta Relief Cream 50g",      category: "Personal Care", buyPrice: 129,  mrp: 185,  stock: 0, unit: "Pack" },
  { id: 101,name: "Assure Body Care Set",               category: "Personal Care", buyPrice: 2499, mrp: 3200, stock: 0, unit: "Set"  },
  { id: 102,name: "Assure Hair Conditioner 75g",        category: "Personal Care", buyPrice: 208,  mrp: 300,  stock: 0, unit: "Pack" },
  { id: 103,name: "Assure Shampoo 200ml",               category: "Personal Care", buyPrice: 175,  mrp: 250,  stock: 0, unit: "Bottle"},
  { id: 104,name: "Assure Professional Shampoo 150ml",  category: "Personal Care", buyPrice: 195,  mrp: 280,  stock: 0, unit: "Bottle"},
  { id: 105,name: "Assure Hair Serum 30ml",             category: "Personal Care", buyPrice: 165,  mrp: 235,  stock: 0, unit: "Bottle"},
  { id: 106,name: "Assure Rinse Off Conditioner 100ml", category: "Personal Care", buyPrice: 240,  mrp: 280,  stock: 0, unit: "Bottle"},
  { id: 107,name: "Assure Cherry Blossom Body Butter 100g",category: "Personal Care",buyPrice: 320,mrp: 360,  stock: 0, unit: "Pack" },
  { id: 108,name: "Assure Vitamin C Gel Creme 50g",     category: "Personal Care", buyPrice: 240,  mrp: 345,  stock: 0, unit: "Pack" },
  { id: 109,name: "Assure Vitamin C Facial Foam 100ml", category: "Personal Care", buyPrice: 335,  mrp: 480,  stock: 0, unit: "Bottle"},
  { id: 110,name: "Dew Garden Sanitary Napkin 10 nos",  category: "Personal Care", buyPrice: 250,  mrp: 290,  stock: 0, unit: "Pack" },
  { id: 111,name: "Dew Garden Foaming Wash 80ml",       category: "Personal Care", buyPrice: 180,  mrp: 210,  stock: 0, unit: "Bottle"},
  { id: 112,name: "Dew Garden Panty Liners 12 nos",     category: "Personal Care", buyPrice: 150,  mrp: 175,  stock: 0, unit: "Pack" },
  { id: 113,name: "Truman Deo 150ml",                   category: "Personal Care", buyPrice: 255,  mrp: 365,  stock: 0, unit: "Bottle"},
  { id: 114,name: "Truman Face Wash 75ml",              category: "Personal Care", buyPrice: 230,  mrp: 330,  stock: 0, unit: "Bottle"},
  { id: 115,name: "Truman Bathing Bar 125g",            category: "Personal Care", buyPrice: 120,  mrp: 175,  stock: 0, unit: "Bar"  },
  // ── HOME CARE ──────────────────────────────────────────────────────────────
  { id: 116,name: "Hyvest Ultrawash Laundry Detergent 500ml", category: "Home Care",buyPrice: 350, mrp: 500,  stock: 0, unit: "Bottle"},
  { id: 117,name: "Hyvest Ultramatic Detergent Powder 500g",  category: "Home Care",buyPrice: 155, mrp: 220,  stock: 0, unit: "Pack" },
  { id: 118,name: "Hyvest Ultrascrub Dishwash Liquid 500ml",  category: "Home Care",buyPrice: 200, mrp: 290,  stock: 0, unit: "Bottle"},
  { id: 119,name: "Hyvest Ultraswab Floor Cleaner 500ml",     category: "Home Care",buyPrice: 186, mrp: 265,  stock: 0, unit: "Bottle"},
  { id: 120,name: "Hyvest Ultraguard Toilet Cleaner 500ml",   category: "Home Care",buyPrice: 110, mrp: 160,  stock: 0, unit: "Bottle"},
  { id: 121,name: "Hyvest Ultra Shine Glass Cleaner 500ml",   category: "Home Care",buyPrice: 150, mrp: 215,  stock: 0, unit: "Bottle"},
  // ── VEHICLE CARE ───────────────────────────────────────────────────────────
  { id: 122,name: "MACH-DRIVE 2-Wheeler 30ml",          category: "Vehicle Care", buyPrice: 1450, mrp: 2060, stock: 0, unit: "Bottle"},
  { id: 123,name: "MACH-DRIVE 4-Wheeler 30ml",          category: "Vehicle Care", buyPrice: 1850, mrp: 2630, stock: 0, unit: "Bottle"},
  // ── MISTRAL OF MILAN ───────────────────────────────────────────────────────
  { id: 124,name: "Mistral Loose Powder",               category: "Mistral",      buyPrice: 530,  mrp: 620,  stock: 0, unit: "Piece"},
  { id: 125,name: "Mistral Micro Compact Powder SPF 10",category: "Mistral",      buyPrice: 480,  mrp: 575,  stock: 0, unit: "Piece"},
  { id: 126,name: "Mistral Brushes 3pc",                category: "Mistral",      buyPrice: 490,  mrp: 570,  stock: 0, unit: "Set"  },
  { id: 127,name: "Mistral Foundation 30ml",            category: "Mistral",      buyPrice: 495,  mrp: 600,  stock: 0, unit: "Bottle"},
  { id: 128,name: "Mistral Sindoor",                    category: "Mistral",      buyPrice: 305,  mrp: 360,  stock: 0, unit: "Piece"},
  { id: 129,name: "Mistral Ultra-Stay Nail Lacquer",    category: "Mistral",      buyPrice: 190,  mrp: 220,  stock: 0, unit: "Piece"},
  { id: 130,name: "Mistral Creme Matte Lipstick",       category: "Mistral",      buyPrice: 360,  mrp: 425,  stock: 0, unit: "Piece"},
  { id: 131,name: "Mistral 4 in 1 Liquid Lipstick",    category: "Mistral",      buyPrice: 650,  mrp: 800,  stock: 0, unit: "Piece"},
  { id: 132,name: "Mistral Nail Polish Remover",        category: "Mistral",      buyPrice: 275,  mrp: 320,  stock: 0, unit: "Piece"},
  { id: 133,name: "Mistral Eyeliner Pencil",            category: "Mistral",      buyPrice: 250,  mrp: 290,  stock: 0, unit: "Piece"},
  { id: 134,name: "Mistral Deep Define Kajal Black",    category: "Mistral",      buyPrice: 190,  mrp: 220,  stock: 0, unit: "Piece"},
  { id: 135,name: "Mistral Showtime Mascara",           category: "Mistral",      buyPrice: 550,  mrp: 645,  stock: 0, unit: "Piece"},
  { id: 136,name: "Mistral 3 in 1 Face Palette",       category: "Mistral",      buyPrice: 650,  mrp: 750,  stock: 0, unit: "Piece"},
  { id: 137,name: "Vellino Compact Powder SPF 15",      category: "Mistral",      buyPrice: 175,  mrp: 195,  stock: 0, unit: "Piece"},
  { id: 138,name: "Vellino Lipstick",                   category: "Mistral",      buyPrice: 210,  mrp: 240,  stock: 0, unit: "Piece"},
  { id: 139,name: "Vellino Lip Tint & Balm",            category: "Mistral",      buyPrice: 170,  mrp: 190,  stock: 0, unit: "Piece"},
  { id: 140,name: "Vellino Nail Lacquer",               category: "Mistral",      buyPrice: 110,  mrp: 125,  stock: 0, unit: "Piece"},
  { id: 141,name: "Vellino Nail Lacquer No.8 & 14",     category: "Mistral",      buyPrice: 130,  mrp: 145,  stock: 0, unit: "Piece"},
  { id: 142,name: "Vellino Nail Lacquer No.9",          category: "Mistral",      buyPrice: 140,  mrp: 155,  stock: 0, unit: "Piece"},
  { id: 143,name: "Vellino Liquid Lipstick",            category: "Mistral",      buyPrice: 220,  mrp: 260,  stock: 0, unit: "Piece"},
  // ── PREMIUM SKIN CARE ──────────────────────────────────────────────────────
  { id: 144,name: "SF-9 Brightening Cream 50g",         category: "Premium Skin", buyPrice: 2200, mrp: 3125, stock: 0, unit: "Pack" },
  { id: 145,name: "SF-9 Youth Elixir Lotion 25ml",      category: "Premium Skin", buyPrice: 1450, mrp: 2060, stock: 0, unit: "Bottle"},
  { id: 146,name: "SF-9 Under Eye Serum 15ml",          category: "Premium Skin", buyPrice: 970,  mrp: 1380, stock: 0, unit: "Bottle"},
  { id: 147,name: "SF-9 Blemish Gel 15ml",              category: "Premium Skin", buyPrice: 950,  mrp: 1350, stock: 0, unit: "Bottle"},
  { id: 148,name: "SF-9 Deep Cleansing Oil 25ml",       category: "Premium Skin", buyPrice: 1200, mrp: 1705, stock: 0, unit: "Bottle"},
  { id: 149,name: "SF-9 Pro-prep & Prime 30ml",         category: "Premium Skin", buyPrice: 675,  mrp: 800,  stock: 0, unit: "Bottle"},
  { id: 150,name: "SF-9 Glow Sheet Mask 30ml",          category: "Premium Skin", buyPrice: 260,  mrp: 370,  stock: 0, unit: "Pack" },
  { id: 151,name: "SF-9 Intense Hydration Cream 50g",   category: "Premium Skin", buyPrice: 1200, mrp: 1380, stock: 0, unit: "Pack" },
  { id: 152,name: "SF-9 Gold Peel Off Mask 50g",        category: "Premium Skin", buyPrice: 855,  mrp: 1000, stock: 0, unit: "Pack" },
  { id: 153,name: "SF-9 Radiant Glow Face Mist 50ml",   category: "Premium Skin", buyPrice: 490,  mrp: 700,  stock: 0, unit: "Bottle"},
  { id: 154,name: "SF-9 Vitamin C Serum 50ml",          category: "Premium Skin", buyPrice: 1025, mrp: 1455, stock: 0, unit: "Bottle"},
  { id: 155,name: "SF-9 Hydrating Sunscreen Serum 50ml",category: "Premium Skin", buyPrice: 1000, mrp: 1420, stock: 0, unit: "Bottle"},
  // ── AGRI CARE ──────────────────────────────────────────────────────────────
  { id: 156,name: "Vestige Agri 82 3x100ml",            category: "Agri Care",    buyPrice: 372,  mrp: 540,  stock: 0, unit: "Pack" },
  { id: 157,name: "Vestige Agri 82 500ml",              category: "Agri Care",    buyPrice: 525,  mrp: 750,  stock: 0, unit: "Bottle"},
  { id: 158,name: "Vestige Agri 82 5 Ltr",              category: "Agri Care",    buyPrice: 4000, mrp: 4500, stock: 0, unit: "Bottle"},
  { id: 159,name: "Vestige Agri 82 Nano 3x100ml",       category: "Agri Care",    buyPrice: 320,  mrp: 381,  stock: 0, unit: "Pack" },
  { id: 160,name: "Vestige Agri 82 Nano 500ml",         category: "Agri Care",    buyPrice: 450,  mrp: 535,  stock: 0, unit: "Bottle"},
  { id: 161,name: "Vestige Agri 82 Nano 5 Ltr",         category: "Agri Care",    buyPrice: 3600, mrp: 4300, stock: 0, unit: "Bottle"},
  { id: 162,name: "Vestige Agri-Humic 500ml",           category: "Agri Care",    buyPrice: 580,  mrp: 700,  stock: 0, unit: "Bottle"},
  { id: 163,name: "Vestige Agri-Humic Granules 5kg",    category: "Agri Care",    buyPrice: 740,  mrp: 900,  stock: 0, unit: "Pack" },
  { id: 164,name: "Vestige Agri-Moss 500ml",            category: "Agri Care",    buyPrice: 1500, mrp: 1750, stock: 0, unit: "Bottle"},
  { id: 165,name: "Vestige Agri-Moss 100ml",            category: "Agri Care",    buyPrice: 330,  mrp: 380,  stock: 0, unit: "Bottle"},
  { id: 166,name: "Vestige Agri-Protek 500g",           category: "Agri Care",    buyPrice: 1250, mrp: 1475, stock: 0, unit: "Pack" },
  { id: 167,name: "Vestige Agri-Protek 250g",           category: "Agri Care",    buyPrice: 630,  mrp: 895,  stock: 0, unit: "Pack" },
  { id: 168,name: "Vestige Agri-Nanotek 500g",          category: "Agri Care",    buyPrice: 1250, mrp: 1475, stock: 0, unit: "Pack" },
  { id: 169,name: "Vestige Agri-Nanotek 250g",          category: "Agri Care",    buyPrice: 630,  mrp: 895,  stock: 0, unit: "Pack" },
  { id: 170,name: "Vestige Agri-Gold 100g",             category: "Agri Care",    buyPrice: 500,  mrp: 710,  stock: 0, unit: "Pack" },
  { id: 171,name: "Vestige Agri-Aquagel 1kg",           category: "Agri Care",    buyPrice: 1800, mrp: 2000, stock: 0, unit: "Pack" },
];
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
        <button onClick={() => window.open("https://wa.me/919999999999?text=Hi%2C%20I%20need%20help%20with%20VManager", "_blank")}
          style={{ flex: 1, padding: "14px 8px", background: "#25D366", color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 13, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          <span style={{ fontSize: 24 }}>💬</span>
          <span>WhatsApp</span>
        </button>
        <button onClick={() => window.open("mailto:support@vmanager.app")}
          style={{ flex: 1, padding: "14px 8px", background: T.navy, color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 13, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          <span style={{ fontSize: 24 }}>✉️</span>
          <span>Email</span>
        </button>
        <button onClick={() => window.open("tel:+919999999999")}
          style={{ flex: 1, padding: "14px 8px", background: T.blue, color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 13, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          <span style={{ fontSize: 24 }}>📞</span>
          <span>Call</span>
        </button>
      </div>
      ...
      <div className="card" style={{ marginBottom: 14 }}>
        ...
        {faqs.map(([q, a], i) => (
          <details key={i} style={{ borderBottom: `1px solid ${T.border}`, padding: "10px 0" }}>
            <summary style={{ fontWeight: 600, fontSize: 13, cursor: "pointer", color: T.navy, listStyle: "none", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              {q} <span style={{ color: T.textLight, fontSize: 18 }}>›</span>
            </summary>
            <div style={{ fontSize: 12, color: T.textMid, marginTop: 8, lineHeight: 1.6, paddingRight: 8 }}>{a}</div>
          </details>
        ))}
      </div>
      ...
      <div className="app-wrap">
        ...
        <div className="topbar">
          ...
          <div className="topbar-right">
            ...
            <button className="icon-btn" onClick={() => setTab("help")}>🆘</button>
            <button className="icon-btn" onClick={() => setTab("profile")}>👤</button>
          </div>
        </div>

        {/* Sync banner */}
        <div style={{ background: syncing ? T.amberLight : T.emeraldLight, padding: "6px 16px", display: "flex", alignItems: "center", gap: 6, justifyContent: "space-between" }}>
          <span style={{ fontSize: 11, color: syncing ? T.amberDark : T.emerald, fontWeight: 600 }}>
            {syncing ? "⏳ Syncing…" : `☁️ ${userProfile?.plan || "Free"} · ${user?.email}`}
          </span>
